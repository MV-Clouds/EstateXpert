        ...
        try {
            this.processedListingData = this.listingData.map(listing => {
                ...
                return {
                    ...
                    MVEX__Listing_Price__c: listing.MVEX__Listing_Price__c,
                    MVEX__Bathrooms__c: listing.MVEX__Bathrooms__c,
                    MVEX__City__c: listing.MVEX__City__c,
                    MVEX__Street__c: listing.MVEX__Street__c,
                    MVEX__isChecked: listing.MVEX__isChecked,
                    MVEX__Address__c: listing.MVEX__Address__c,
                    cardViewFields,
                    orderedFields,
    ...
    */
    ...
    redirectToVisitBooking(event) {
        try {
            ...
            let componentDef = {
                componentDef: "MVEX:siteAndBookingManagement",
                attributes: {
                    recordId: recordId
                }
            };
