                ...
                this.data.forEach(record => {
                    ...
                    this.mapMarkers2.push({
                        location: {
                            ...
                            Country: record.MVEX__Address__CountryCode__s,
                            PostalCode: record.MVEX__Address__PostalCode__s,
                            State: record.MVEX__Address__StateCode__s,
                            Street: record.MVEX__Address__Street__s
                        },
                        title: record.Name,
                        description: `
                        <b>Address:-</b> 
                        ${record.MVEX__Address__Street__s ? record.MVEX__Address__Street__s + ',' : ''} 
                        ${record.MVEX__Address__City__s ? record.MVEX__Address__City__s + ',' : ''}
                        ${record.MVEX__Address__StateCode__s ? record.MVEX__Address__StateCode__s + ',' : ''}
                        ${record.MVEX__Address__CountryCode__s ? record.MVEX__Address__CountryCode__s + ',' : ''} 
                        <br><b>Sq_Ft:-</b> 
