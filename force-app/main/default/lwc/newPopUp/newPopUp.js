    ...
    */
    connectedCallback() {
        try {
            ...
            errorDebugger('NewPopUp', 'connectedCallback', error, 'warn', 'Error in connectedCallback');
        }
    }
    ...
    */
    setFieldsInHTMLView() {
        try {
            ...
            .catch(error => {
                errorDebugger('NewPopUp', 'setFieldsInHTMLView', error, 'warn', 'Error in setFieldsInHTMLView');
            });
        } catch (error) {
            errorDebugger('NewPopUp', 'setFieldsInHTMLView', error, 'warn', 'Error in setFieldsInHTMLView');
        }
    ...
    */
    updateFields() {
        try {
            ...
            errorDebugger('NewPopUp', 'updateFields', error, 'warn', 'Error in updateFields');
            this.isSpinner = false;
        }
    }
    ...
    */
    getTheFieldValue(event) {
        try {
            ...
            errorDebugger('NewPopUp', 'getTheFieldValue', error, 'warn', 'Error in getTheFieldValue');
        }
    ...
    */
    validateFields() {
        try {
            ...
            errorDebugger('NewPopUp', 'validateFields', error, 'warn', 'Error in validateFields');
        }
    }
    ...
    savePortalRecord() {
        try {
            ...
            savePropertyPortalRecord({ portalWrapper: JSON.stringify(portalWrapper), portalName: this.getPortalName })
                ...
                .catch(error => {
                    errorDebugger('NewPopUp', 'savePortalRecord', error, 'warn', 'Error in savePortalRecord');
    ...
    */
    handleDialogueClose() {
        try {
            ...
            errorDebugger('NewPopUp', 'handleDialogueClose', error, 'warn', 'Error in handleDialogueClose');
        }
    }
    ...
    */
    showToast(title, message, variant) {
        try {
            ...
            errorDebugger('NewPopUp', 'showToast', error, 'warn', 'Error in showToast');
        }
    }
